...
class ChecksumTest {
    ...
    private val realData ="62\t1649\t1731\t76\t51\t1295\t349\t719\t52\t1984\t2015\t2171\t981\t1809\t181\t1715\n" +
    ...
    @Test
    fun singleRow() {
        testChecksum(2, "1\t2\t3")
    }

    @Test
    fun multiRow() {
        testChecksum(18, "5\t1\t9\t5\n7\t5\t3\n2\t4\t6\t8")
    }

    @Test
    fun realData() {
        testChecksum(44216, realData)
    }

    @Test
    fun testEvenSampleData() {
        testEvensData(9, "5\t9\t2\t8\n9\t4\t7\t3\n3\t8\t6\t5")
    }

    @Test
    fun testEvenRealData() {
        testEvensData(320, realData)
    }

    private fun testChecksum(expectedResult: Int, data: String) {
        assertEquals(expectedResult, checksum.calculateChecksum(data))
    }

    private fun testEvensData(expectedResult: Int, data: String) {
        assertEquals(expectedResult, checksum.calculateEvenlyDivisible(data))
    }
}